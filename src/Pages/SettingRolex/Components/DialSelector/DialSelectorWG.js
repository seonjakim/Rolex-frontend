...
import "./DialSelectorWG.scss";

export default class DialSelectorWG extends Component {
  constructor() {
    super();
    this.state = {
      dialData: [],
  ...
  getData = () => {
    fetch("http://localhost:3000/data/dialDataWG.json")
      .then((res) => res.json())
      .then((res) => {
