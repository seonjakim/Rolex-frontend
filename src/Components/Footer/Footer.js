        ...
        return (
            <div className="Footer">
                <div className="header">
                    <div>
                        <svg aria-labelledby="" height="21" width="21" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg" role="img" class="languages" name="search">
                ...
                <div className="body">
                    <div className="bodyLeft">
                        <div className="bodySection">
                            ...
                            <ul className="liFont colorChange">
                                <li>롤렉스 컬렉션</li>
                                <li>시계 설정하기</li>
                                <li>시계 골라보기</li>
                                <li>남성 시계</li>
                                <li>여성 시계</li>
                                <li>역사 & 워치메이킹</li>
                                <li>롤렉스 시계에 담긴 이야기</li>
                            </ul>
                        </div>
                        <div className="bodySection">
                            <p className="titleFont">롤렉스 세계</p>
                            <ul className="liFont colorChange">
                                <li>스포츠와 예술, 탐험</li>
                            </ul>
                        </div>
                        <div className="bodySection">
                            <p className="titleFont">서비스</p>
                            <ul className="liFont colorChange">
                                <li>공식 판매점 찾기</li>
                                <li>시계 관리 & 서비스</li>
                                <li>나의 셀렉션</li>
                                <li>자주 묻는 질문</li>
                                <li>
                                    <svg aria-labelledby="" height="15" width="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" role="img" class="footer-icon">
                    ...
                    <div className="bodyRight">
                        <div className="bodySection">
                            ...
                            <ul className="liFont colorChange">
                                ...
                                <li>
                                    <svg aria-labelledby="" height="15" width="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" role="img" class="footer-icon">
                                        <path d="m7.5 0c-4.14 0-7.5 3.36-7.5 7.5s3.36 7.5 7.5 7.5 7.5-3.36 7.5-7.5-3.36-7.5-7.5-7.5zm0 13.06c-3.07 0-5.56-2.5-5.56-5.56s2.5-5.56 5.56-5.56 5.56 2.5 5.56 5.56-2.49 5.56-5.56 5.56zm-1.94-9.43 4.84 3.87-4.84 3.87z">
                                        </path>
                                    </svg>
                                    유쿠
                                </li>
                ...
                <div className="footerFoot">
                    <svg aria-labelledby="" height="11" width="11" viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg" role="img">
                        <path d="m5.78 8h1.22v1.78 1.22h-1.22-4.56-1.22v-1.22-8.56-1.22h1.22 4.57 1.21v1.22 1.78h-1.22v-1.78h-4.56v8.57h4.57v-1.79zm4.03-3.7-1.18-1.2v1.8h-5.63v1.22h5.63v1.8l1.19-1.2 1.18-1.22z">
                        </path>
                    </svg>
